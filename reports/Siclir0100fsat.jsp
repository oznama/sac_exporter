<%
/*###############################################################################
# Nombre del Programa :  SICLIR0100FSAT.jsp	    								#
# Autor               :  GERMAN GONZALEZ ESQUIVEL                               #
# Compania            :  WELLCOM S.A. DE C.V.                                   #
# Proyecto/Procliente :  N-04-2862-13                 	   FECHA:07/11/2013     #
# Descripcion General :															#
#                                                                               #
...
<html>
	...
	<body>
		...
		%>
		<birt:viewer id="birtViewer" reportDesign="<%=getServletContext().getInitParameter(\"UBICACION_REPORTES\")+\"/siclir0100fsat.rptdesign\"%>"
			showParameterPage="false" showTitle="true" pattern="frameset"
			format="HTML" isHostPage="true" title="SISTEMA ADQUIRENTE CARNET SAC 2 SICLIR0100FSAT" showToolBar="true" 
